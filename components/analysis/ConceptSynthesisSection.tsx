            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 bg-gray-50 dark:bg-slate-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                    <input 
                        ...
                        className="flex-1 bg-white dark:bg-slate-900 border border-gray-300 dark:border-slate-700 rounded-lg px-4 py-2 text-sm text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-cyan focus:ring-offset-1 dark:focus:ring-offset-slate-800"
                    />
                    <select 
                        value={selectedAspectRatio} 
                        onChange={(e) => setSelectedAspectRatio(e.target.value)}
                        className="bg-white dark:bg-slate-900 border border-gray-300 dark:border-slate-700 rounded-lg px-3 py-2 text-xs font-bold text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-cyan focus:ring-offset-1 dark:focus:ring-offset-slate-800"
                    >
                    ...
                    <button 
                        ...
                        className="px-6 py-2 bg-brand-cyan text-white font-bold rounded-lg hover:bg-cyan-600 transition-all shadow-sm flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-brand-cyan focus:ring-offset-2 dark:focus:ring-offset-slate-800 active:scale-95"
                    >
                                ...
                                {img.url ? (
                                    ...
                                    <div className="absolute inset-0 bg-slate-900/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                                        <button 
                                            ...
                                            className="p-2 bg-red-500/20 text-red-500 border border-red-500/50 rounded-full hover:bg-red-500 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 active:scale-95"
                                            title="Purge Image"
                                        >
                                        ...
                                        <button 
                                            ...
                                            className={`p-2 rounded-full border transition-colors focus:outline-none focus:ring-2 focus:ring-brand-cyan focus:ring-offset-2 dark:focus:ring-offset-slate-900 active:scale-95 ${img.includeInReport ? 'bg-brand-cyan text-white border-brand-cyan' : 'bg-slate-700/50 text-slate-300 border-slate-600 hover:bg-brand-cyan/20'}`}
