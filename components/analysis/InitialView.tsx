...
export const InitialView = () => (
  <div className="bg-gray-900 border-2 border-dashed border-gray-700 rounded-lg p-8 h-full flex flex-col items-center justify-center text-center animate-fade-in">
    ...
    <h2 className="text-2xl font-bold text-brand-light mb-2">Welcome to SynapseForge AI</h2>
    ...
    <div className="mt-6 text-left bg-gray-800/50 p-4 rounded-lg border border-gray-700 max-w-lg">
        <h3 className="font-semibold text-brand-light mb-2">How to Begin:</h3>
    ...
    <p className="text-xs text-gray-500 mt-4">For a detailed guide, open the "User Manual" from the header.</p>
  </div>
);